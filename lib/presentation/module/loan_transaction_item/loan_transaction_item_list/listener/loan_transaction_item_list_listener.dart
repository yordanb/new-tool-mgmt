...
class LoanTransactionItemListListener extends SingleChildStatelessWidget {
  const LoanTransactionItemListListener({
    super.key,
    super.child,
  });
  ...
  Widget buildWithChild(BuildContext context, Widget? child) {
    return BlocListener<LoanTransactionItemListCubit,
