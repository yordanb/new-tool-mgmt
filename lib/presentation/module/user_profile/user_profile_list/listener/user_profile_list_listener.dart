...
class UserProfileListListener extends SingleChildStatelessWidget {
  const UserProfileListListener({
    super.key,
    super.child,
  });
  ...
  Widget buildWithChild(BuildContext context, Widget? child) {
    return BlocListener<UserProfileListCubit, UserProfileListState>(
