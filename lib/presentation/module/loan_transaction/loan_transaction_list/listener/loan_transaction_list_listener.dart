...
class LoanTransactionListListener extends SingleChildStatelessWidget {
  const LoanTransactionListListener({
    super.key,
    super.child,
  });
  ...
  Widget buildWithChild(BuildContext context, Widget? child) {
    return BlocListener<LoanTransactionListCubit, LoanTransactionListState>(
