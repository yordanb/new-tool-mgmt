...
_$UserProfileMembershipEntityImpl _$$UserProfileMembershipEntityImplFromJson(
...
Map<String, dynamic> _$$UserProfileMembershipEntityImplToJson(
        _$UserProfileMembershipEntityImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
