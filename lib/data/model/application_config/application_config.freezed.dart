...
mixin _$ApplicationConfig {
  ...
  /// Serializes this ApplicationConfig to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ApplicationConfig
...
/// @nodoc
abstract class _$$ApplicationConfigImplCopyWith<$Res>
    implements $ApplicationConfigCopyWith<$Res> {
  factory _$$ApplicationConfigImplCopyWith(_$ApplicationConfigImpl value,
          $Res Function(_$ApplicationConfigImpl) then) =
      __$$ApplicationConfigImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'id') int? id,
...
/// @nodoc
class __$$ApplicationConfigImplCopyWithImpl<$Res>
    extends _$ApplicationConfigCopyWithImpl<$Res, _$ApplicationConfigImpl>
    implements _$$ApplicationConfigImplCopyWith<$Res> {
  __$$ApplicationConfigImplCopyWithImpl(_$ApplicationConfigImpl _value,
      $Res Function(_$ApplicationConfigImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ApplicationConfigImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ApplicationConfigImpl implements _ApplicationConfig {
  _$ApplicationConfigImpl(
  ...
  factory _$ApplicationConfigImpl.fromJson(Map<String, dynamic> json) =>
      _$$ApplicationConfigImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ApplicationConfig(id: $id, appMode: $appMode, companyName: $companyName, address: $address, phoneNumber: $phoneNumber, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ApplicationConfigImplCopyWith<_$ApplicationConfigImpl> get copyWith =>
      __$$ApplicationConfigImplCopyWithImpl<_$ApplicationConfigImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ApplicationConfigImplToJson(
      this,
    );
  }
}
...
abstract class _ApplicationConfig implements ApplicationConfig {
  ...
  factory _ApplicationConfig.fromJson(Map<String, dynamic> json) =
      _$ApplicationConfigImpl.fromJson;
