...
class _$AuthModelImpl implements _AuthModel {
  ...
  @override
  String toString() {
    return 'AuthModel(id: $id, userProfileId: $userProfileId, name: $name, email: $email, imageUrl: $imageUrl, accessToken: $accessToken, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _AuthModel implements AuthModel {
  factory _AuthModel(
      ...
      @JsonKey(name: 'access_token') String? accessToken,
      @JsonKey(name: 'created_at') DateTime? createdAt,
      @JsonKey(name: 'updated_at') DateTime? updatedAt}) = _$AuthModelImpl;
