...
_$UserProfileMembershipImpl _$$UserProfileMembershipImplFromJson(
...
Map<String, dynamic> _$$UserProfileMembershipImplToJson(
        _$UserProfileMembershipImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
