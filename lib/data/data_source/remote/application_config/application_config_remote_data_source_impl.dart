...
class ApplicationConfigRemoteDataSourceImpl
    implements ApplicationConfigRemoteDataSource {
  ...
  Future<int> count(
    ...
    var query = client.from('application_config').select(
      """
*
""",
    );
  ...
  *
  ...
  Future<void> update({
    ...
    try {
      ...
      await client.from('application_config').update(value).eq('id', id).exec();
    } on Exception catch (err) {
      throw Exception(err);
    }
  }
  ...
  Future<void> delete(int id) async {
    try {
      await client.from('application_config').delete().eq('id', id).exec();
    } on Exception catch (err) {
      throw Exception(err);
    }
  }
  ...
  Future<void> deleteAll() async {
    try {
      await client.from('application_config').delete().neq('id', -1).exec();
      ;
    } on Exception catch (err) {
      throw Exception(err);
    }
