...
class _QFilePickerState extends State<QFilePicker> {
  ...
  Future<String?> getFileMultiplePlatform() async {
    printr("This features is disabled temporary!");
    return null;
    //NOTES: there's a problem with current file_picker plugin
    // so, i temporary remove this code and
    // makes the file picker disabled for now
