...
String _googleMapApiKey = "YourApiKey";
...
class _GoogleMapViewerState extends State<GoogleMapViewer> {
  ...
  Future<List<String>> _fetchPlaces(String input) async {
    ...
    final url = '$baseUrl?input=$input&key=${_googleMapApiKey}';
  ...
  Future<LatLng> getPlaceLatLng(String place) async {
    ...
    final url =
        '$baseUrl?input=$place&inputtype=textquery&fields=geometry&key=${_googleMapApiKey}';
  ...
  Future<void> getAddress(double latitude, double longitude) async {
    ...
    final url =
        '$baseUrl?latlng=$latitude,$longitude&key=${_googleMapApiKey}'; // Replace with your Google Maps API key
