...
late final SupabaseClient mockSupabase;
  ...
  t.test('LoanTransactionItemListCubit Delete Test', () async {
    final cubit = await sl<LoanTransactionItemListCubit>();
    await cubit.delete(1);
  });

  t.test('LoanTransactionItemListCubit Delete All Test', () async {
    final cubit = await sl<LoanTransactionItemListCubit>();
