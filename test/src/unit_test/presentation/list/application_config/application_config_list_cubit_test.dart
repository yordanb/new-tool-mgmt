...
late final SupabaseClient mockSupabase;
  ...
  t.test('ApplicationConfigListCubit Delete Test', () async {
    final cubit = await sl<ApplicationConfigListCubit>();
    await cubit.delete(1);
  });

  t.test('ApplicationConfigListCubit Delete All Test', () async {
    final cubit = await sl<ApplicationConfigListCubit>();
