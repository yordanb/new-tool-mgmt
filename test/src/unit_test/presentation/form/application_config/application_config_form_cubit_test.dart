...
late final SupabaseClient mockSupabase;
  ...
  t.test('ApplicationConfigFormCubit Get Current Data', () async {
    final cubit = await sl<ApplicationConfigFormCubit>();
  ...
  t.test('ApplicationConfigFormCubit Create Data', () async {
    final cubit = await sl<ApplicationConfigFormCubit>();
    final state = cubit.state;
...
state.updatedAt = DateTime.now();
  ...
  t.test('ApplicationConfigFormCubit Update Data', () async {
    final cubit = await sl<ApplicationConfigFormCubit>();
    final state = cubit.state;
    state.id = 1;
    state.appMode = r.firstValueFromList(["Production", "Development", "Maintenance"]);
